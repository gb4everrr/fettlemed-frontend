...
export const BillingStats: React.FC<BillingStatsProps> = ({ revenue, totalInvoices, uniquePatients }) => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
      ...
      <Card padding="lg" className="border-l-4 border-l-purple-500 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-sm font-medium text-gray-500 mb-1 font-inter">Billed Patients</p>
