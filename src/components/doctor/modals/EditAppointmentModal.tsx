// src/components/doctor/modals/EditAppointmentModal.tsx
'use client';
...
export function EditAppointmentModal({
  ...
  // --- REPLICATED LOGIC: Resolve Display Names ---
  // In 'My View', the API often omits the doctor object. We must fallback to the 'user' prop.
